...
import com.alexis.fragments.InicialCapturaPedido
import com.alexis.models.Producto
import com.example.diseno_prueba.R
import com.example.diseno_prueba.databinding.ActivityCapturaPedidoBinding
...
class CapturaPedido : AppCompatActivity(){
    ...
    lateinit var binding: ActivityCapturaPedidoBinding;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCapturaPedidoBinding.inflate(layoutInflater)
        setContentView(binding.root)

        botonRealizarPedido = binding.botonRealizarPedido
        toolbar = binding.toolbarCapturaPedido
        toolbar.title = getString(R.string.tomar_pedido)
